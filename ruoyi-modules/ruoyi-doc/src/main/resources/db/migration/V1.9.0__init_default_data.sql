...
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, active_menu, ext, create_dept, create_by, create_time, update_by, update_time, remark)
VALUES (2010, '我的文档', 2000, 1, 'my-docs', 'doc/my/index', null, 'N', 'Y', 'C', '0', '0', 'doc:my:list', 'folder', '', '', 103, 1, CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, '我的文档'),
       (2020, '资料库',   2000, 2, 'library', 'doc/library/index', null, 'N', 'Y', 'C', '0', '0', 'doc:library:list', 'folder', '', '', 103, 1, CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, '公共资料库'),
       (2030, '共享给我', 2000, 3, 'shared', 'doc/shared/index', null, 'N', 'Y', 'C', '0', '0', 'doc:shared:list', 'share', '', '', 103, 1, CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, '共享给我'),
